...
import com.seljabali.core.threeten.NOW
import com.seljabali.core.threeten.ZonedDateTimeUtil
import com.seljabali.core.threeten.getMonthBaseZero
import com.seljabali.core.threeten.print
...
class DatePickerFragment : BaseFragment() {
    ...
    companion object {
        ...
        private val DATE_FORMAT: String = com.seljabali.core.threeten.Formats.YearMonthDay.MM_DD_YYYY_SLASH.toString()
    }
