...
import com.seljabali.core.threeten.NOW_TIME
...
class TimePickerFragment : BaseFragment() {
    ...
    companion object {
        ...
        private val TIME_24_FORMAT: String = com.seljabali.core.threeten.Formats.Time.HH_MM_24.toString()
        private val TIME_AM_PM_FORMAT: String = com.seljabali.core.threeten.Formats.Time.HH_MM_AM.toString()
    }
